...
export const ROUTES: Routes = [
  ...
  {path: 'wettkaempfe', loadChildren: 'src/app/modules/mannschaft/mannschaft.module#MannschaftModule'},
  ...
  {path: 'ligatabelle', loadChildren: 'src/app/modules/wettkampf/wettkampf.module#WettkampfModule'},
];
