...
@Component({
  selector: 'bla-download-actionbutton',
  templateUrl: './download-actionbutton.component.html'
})
export class DownloadActionButtonComponent extends ActionButtonComponent implements OnInit {
