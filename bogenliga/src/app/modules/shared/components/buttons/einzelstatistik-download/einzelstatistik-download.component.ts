...
@Component({
  selector: 'bla-einzelstatistik-download',
  templateUrl: './einzelstatistik-download.component.html'
})
export class EinzelstatistikDownloadComponent implements OnInit {
