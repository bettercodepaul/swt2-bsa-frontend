...
export class WettkampfTableDo implements DataObject {
  ...
  constructor(wettkampfTag: string, wettkampfUhrzeit: string, wettkampfLiga: string, wettkampfStrasse: string, wettkampfPlz: string, wettkampfOrtsname: string, wettkampfOrtsinfo: string) {
