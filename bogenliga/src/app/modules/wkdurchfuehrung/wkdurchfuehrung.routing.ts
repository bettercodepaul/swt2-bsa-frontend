...
export const wkdurchfuehrung_ROUTES: Routes = [
  ...
  {path: 'bildschirm-registrierung', pathMatch: 'full', component: AnzeigePhysischeIDComponent},
  {path: 'fullscreen', pathMatch: 'full', component: FullscreenComponent, canActivate: [WkdurchfuehrungGuard]},
  {path: 'letzte-match-fullscreen', pathMatch: 'full', component: TabelleErgebnisLetzteMatchComponent, },
