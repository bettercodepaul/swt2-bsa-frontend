...
var sunburst = Kapsule({
  ...
  init: function init(domNode, state) {
    ...
    state.canvas.on('mousemove', function () {
      state.tooltip.style('left', d3Selection.event.pageX + 'px').style('top', d3Selection.event.pageY + 'px').style('transform', "translate(-".concat(d3Selection.event.pageX / state.width * 100, "%, 21px)")); // adjust horizontal position to not exceed canvas boundaries
  ...
  update: function update(state) {
    ...
    var transition = d3Transition.transition().duration(TRANSITION_DURATION); // Apply zoom
